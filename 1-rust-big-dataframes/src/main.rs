//! Aggregator that computes the mean of a dataframe in chunks. 
...
fn get_schema() -> Schema {
    Schema::new(vec![
        Field::new("category", polars::prelude::DataType::List(ArrowDataType::Utf8)),
        Field::new("calories", polars::prelude::DataType::List(ArrowDataType::UInt64)),
        Field::new("fats_g", polars::prelude::DataType::List(ArrowDataType::Float64)),
        Field::new("sugars_g", polars::prelude::DataType::List(ArrowDataType::Float64)),
    ])
}
...
fn compute_mean(
    ...
    let sum_column = dataframe
        ...
        .cast_with_datatype(&polars::prelude::DataType::List(ArrowDataType::Float64))?;
